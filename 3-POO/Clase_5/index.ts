        ...
        case 'R': {
            ...
            switch (opcion2) {
                case 'T': {      
                    ...
                    if (isPrendaT.length > 0) {                         
                        console.log(`Se encontró la prenda de tipo ${prendaT} con estas características: ${miTienda.imprimirPrendas(isPrendaT)}`); 
                    } else {
